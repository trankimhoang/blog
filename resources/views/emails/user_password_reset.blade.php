            ...
            <tr>
                <td align="center" class="vervelogoplaceholder" height="143"
                    ...
                    valign="middle"><span class="sg-image"
                            ...
                            href="#" target="_blank"><img alt="Verve Wine" height="34"
                                                          src="https://marketing-image-production.s3.amazonaws.com/uploads/79d8f4f889362f0c7effb2c26e08814bb12f5eb31c053021ada3463c7b35de6fb261440fc89fa804edbd11242076a81c8f0a9daa443273da5cb09c1a4739499f.png"
                                                          style="border-width: 0px; width: 160px; height: 34px;"
                                                          width="160"></a></span></td>
            </tr>
            <!-- Start of Email Body-->
            <tr>
                                ...
                                <center>
                                    ...
                                    <p class="description center"
                                       style="font-family:'Muli','Arial Narrow',Arial;Margin:0;text-align:center;max-width:320px;color:#a1a8ad;line-height:24px;font-size:15px;Margin-bottom:10px;margin-left: auto; margin-right: auto;">
                                        <span
                                            style="color: rgb(161, 168, 173); font-family: Muli, &quot;Arial Narrow&quot;, Arial; font-size: 15px; text-align: center; background-color: rgb(255, 255, 255);">{{ __('hi') }} {{ $name }}, {{ __('click to reset password') }}.</span>
                                    </p>
                                    <!--[if (gte mso 9)|(IE)]><br>&nbsp;<![endif]--><span class="sg-image"
                                            ...
                                            href="{{ $url }}" target="_blank"><img alt="Reset your Password" height="54"
            ...
            <tr>
                <td align="center" style="padding-bottom:0;padding-right:0;padding-left:0;padding-top:0px;"
                    valign="middle"><span class="sg-image"
                            ...
                            href="https://www.facebook.com/vervewine/" target="_blank"><img alt="Facebook" height="18"
                    ...
                    <!--[if gte mso 9]>&nbsp;&nbsp;&nbsp;<![endif]--><span class="sg-image"
                            ...
                            href="https://twitter.com/vervewine" target="_blank"><img alt="Twitter" height="18"
                    ...
                    <!--[if gte mso 9]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]--><span class="sg-image"
                            ...
                            href="https://www.instagram.com/vervewine/" target="_blank"><img alt="Instagram" height="18"
                ...
                <td style="padding-top:0;padding-bottom:0;padding-right:30px;padding-left:30px;text-align:center;Margin-right:auto;Margin-left:auto;">
                    <center>
                        <p style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;font-size:15px;color:#a1a8ad;line-height:23px;">
                            ...
                            <nobr><a class="tel" href="tel:2128102899" style="color:#a1a8ad;text-decoration:none;"
                                     target="_blank"><span style="white-space: nowrap">212.810.2899</span></a></nobr>
                        </p>

                        <p style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;font-size:15px;color:#a1a8ad;line-height:23px;">
                            or email <a href="mailto:hello@vervewine.com"
                                        style="color:#a1a8ad;text-decoration:underline;" target="_blank">hello@vervewine.com</a>
                        </p>
                        ...
                        <p style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;padding-top:10px;padding-bottom:0px;font-size:15px;color:#a1a8ad;line-height:23px;">
                            © Verve Wine <span style="white-space: nowrap">24 ​Hubert S​t​</span>, <span
                                style="white-space: nowrap">Ne​w Yor​k,</span> <span style="white-space: nowrap">N​Y 1​0013</span>
                        </p>
                    </center>
                </td>
            </tr>
