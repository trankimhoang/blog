            ...
            <ul class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                @foreach($listCategory as $category)
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4"
                                            href="{{ route('web.category.detail', $category->id) }}}">{{ $category->name }}</a>
                    </li>
                @endforeach
            ...
            <div class="col-md-10 col-lg-8 col-xl-7">
                <ul class="list-inline text-center">
                    <li class="list-inline-item">
                        <a href="https://www.facebook.com/Trankimhoang115">
                    ...
                    <li class="list-inline-item">
                        <a href="https://github.com/trankimhoang">
                                    <span class="fa-stack fa-lg">
                                        <i class="fas fa-circle fa-stack-2x"></i>
                ...
                <div class="small text-center text-muted fst-italic">Copyright &copy; TranKimHoang 2022</div>
            </div>
        </div>
    </div>
</footer>
